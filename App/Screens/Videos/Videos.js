          ...
          <View style={styles.mainView}>
            <View style={styles.HeaderView}>
              <View style={styles.HeaderStart}>
                ...
                <Text style={styles.HeaderTxt}>Videos</Text>
                <Image
            ...
            <TouchableOpacity
            activeOpacity={1}
            onPress={()=> this.setState({videoPlay: item.id, PlayBack:!this.state.PlayBack})}> 
                <Video
              source={require('../../assets/Video.mp4')}
              ref={ref => {
                this.player = ref;
              }}
              paused={this.state.videoPlay === item.id && this.state.PlayBack ? false : true}
